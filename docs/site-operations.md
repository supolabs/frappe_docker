...
For full instructions, refer to the [wiki](https://github.com/supolabs/frappe/wiki/Using-Frappe-with-Amazon-RDS-(or-any-other-DBaaS)). Common question can be found in Issues and on forum.
